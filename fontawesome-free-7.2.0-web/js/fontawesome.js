...
;(function () {
                        ...
                        _defineProperty(
                            _defineProperty(
                                _defineProperty(
                                    _defineProperty(
                                        _defineProperty(
                                            _defineProperty(_defineProperty(_ht, i, c), t, I),
                                            d,
                                            F,
                                        ),
                                        l,
                ...
                _defineProperty(
                    _defineProperty(
                        _defineProperty(
                            _defineProperty(
                                _defineProperty(
                                    _defineProperty(_defineProperty(_defineProperty(_ht, m, k), e, D), y, T),
                                    p,
                                    C,
                                ),
                                s,
                        ...
                        _defineProperty(
                            _defineProperty(
                                _defineProperty(
                                    _defineProperty(
                                        _defineProperty(
                                            _defineProperty(_defineProperty(_wt, h$1, v$1), o$1, S$1),
                                            n$1,
                                            A$1,
                                        ),
                                        s$1,
                    ...
                    _defineProperty(
                        _defineProperty(
                            _defineProperty(
                                _defineProperty(
                                    _defineProperty(
                                        _defineProperty(_defineProperty(_wt, w$1, T$1), e$1, L$1),
                                        b$1,
                                        W$1,
                                    ),
                                    c$1,
    ...
    var Hl = {
        ...
        so = []
            .concat(_toConsumableArray(Object.keys(Y$1)), $, H$1, [
                '2xs',
                'xs',
                'sm',
                'lg',
    ...
    var newCanonicalStyles = Object.keys(Xl)
        .filter(function (key) {
            return key !== i
        })
        .map(function (key) {
